...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="vod-voice", description="Enter-to-talk local speech-to-text.")
    parser.add_argument("--device", default=None, help="Input device index or name substring")
    parser.add_argument("--list-devices", action="store_true", help="List input devices and exit")
    args = parser.parse_args(argv)

    print("LIST DEVICES:", args.list_devices)
